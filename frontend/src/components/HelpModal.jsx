  ...
  return (
    <div className="help-body">
      ...
      <p>
        ...
        진출 경로를 <b>따로</b> 그리세요. (예: 입구→진입게이트→승강장 / 승강장→진출게이트→출구).
        기본 예제가 이렇게 구성되어 있습니다. 한 노드는 그 안의 사람을 구분하지 않으므로, 같은
        노드에 양방향 링크를 달면 일부가 되돌아갑니다.
      </p>

      <h4>③ 발생·열차 설정</h4>
      <ul>
        <li><b>출입구</b>: 속성에서 유입 분포(푸아송/정규/상수)와 평균을 정합니다. (러시아워 프로파일도 적용 가능)</li>
        <li><b>승강장</b>: "열차 추가"로 도착 시점·하차 인원·정차 시간·탑승량을 정합니다. 하차=유입, 탑승=유출입니다.</li>
      </ul>
